...
method, the partition function of a free field, and half of statistics.

$$
  \left(\int_{-\infty}^{\infty} e^{-x^2}\,\diff{x}\right)^{\!2}
    = \int_0^{2\pi}\!\!\int_0^{\infty} e^{-r^2}\, r \,\diff{r}\,\diff{\theta} = \pi.
$$

Remove `draft: true` above once this is written.
